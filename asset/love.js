(function(window){
    ...
    // Function to generate random blue shades
    ...
    Seed = function(tree, point, scale, color) {
        ...
        var scale = scale || 1
        var color = color || getRandomBlue(); // Use random blue
    ...
    Tree.prototype = {
        initSeed: function() {
            ...
            var color = seed.color || getRandomBlue(); // Use random blue
        ...
        createBloom: function(width, height, radius, figure, color, alpha, angle, scale, place, speed) {
            ...
            while (true) {
                ...
                if (inheart(x - width / 2, height - (height - 40) / 2 - y, radius)) {
                    return new Bloom(this, new Point(x, y), figure, getRandomBlue(), alpha, angle, scale, place, speed); // Use random blue
                }
            }
        },
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || getRandomBlue(); // Use random blue
